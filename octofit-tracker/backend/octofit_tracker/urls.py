...
urlpatterns = [
    ...
    path('api/activity/', views.ActivityViewSet.as_view(), name='activity-list'),
    path('api/activity/<str:activity_id>/', views.ActivityViewSet.as_view(), name='activity-detail'),
